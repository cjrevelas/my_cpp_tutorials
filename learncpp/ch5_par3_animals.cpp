...
int main()
{
	...
	animal = CAT;
	std::cout << "A " << getAnimalName(animal) << " has " << printNumberOfLegs(animal) << " legs." << std::endl;
...
std::string getAnimalName(Animal animal)    //passed by value and given the same name
{
